...
func (api *PublicFilterAPI) Logs(ctx context.Context, crit FilterCriteria) (*rpc.Subscription, error) {
	...
	logsSub, err := api.events.SubscribeLogs(jumbochain.FilterQuery(crit), matchedLogs)
	if err != nil {
		return nil, err
	}
...
// Same as jumbochain.FilterQuery but with UnmarshalJSON() method.
type FilterCriteria jumbochain.FilterQuery
...
func (api *PublicFilterAPI) NewFilter(crit FilterCriteria) (rpc.ID, error) {
	...
	logsSub, err := api.events.SubscribeLogs(jumbochain.FilterQuery(crit), logs)
	if err != nil {
		return "", err
	}
