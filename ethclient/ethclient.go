...
func (ec *Client) getBlock(ctx context.Context, method string, args ...interface{}) (*types.Block, error) {
	...
	if err != nil {
		...
		return nil, jumbochain.NotFound
	}
...
func (ec *Client) TransactionByHash(ctx context.Context, hash common.Hash) (tx *types.Transaction, isPending bool, err error) {
	...
	if err != nil {
		...
		return nil, false, jumbochain.NotFound
...
func (ec *Client) SyncProgress(ctx context.Context) (*jumbochain.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (jumbochain.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q jumbochain.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q jumbochain.FilterQuery, ch chan<- types.Log) (jumbochain.Subscription, error) {
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
...
func toFilterArg(q jumbochain.FilterQuery) (interface{}, error) {
...
func (ec *Client) CallContract(ctx context.Context, msg jumbochain.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) CallContractAtHash(ctx context.Context, msg jumbochain.CallMsg, blockHash common.Hash) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) PendingCallContract(ctx context.Context, msg jumbochain.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) EstimateGas(ctx context.Context, msg jumbochain.CallMsg) (uint64, error) {
...
func toCallArg(msg jumbochain.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
...
func (p *rpcProgress) toSyncProgress() *jumbochain.SyncProgress {
	if p == nil {
		return nil
	}
	return &jumbochain.SyncProgress{
